...
<@layout.htmlEmailLayout accentColor="#DC2626" category="SÉCURITÉ DU COMPTE">
  ...
  <tr>
    <td style="padding:32px 32px 28px;font-family:Arial,Helvetica,sans-serif;">
      ...
      <p style="margin:0 0 24px;font-size:14px;color:#555555;line-height:1.6;">Un fournisseur d'identité externe a été lié avec succès à votre compte Financia Capital. Vous pouvez désormais vous connecter en utilisant ce fournisseur.</p>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 12px;">
        <tr>
          <td style="background-color:#F0F9F4;border-left:3px solid #1B6B45;border-radius:0 6px 6px 0;padding:12px 16px;">
            <p style="margin:0;font-size:13px;color:#166534;line-height:1.5;font-family:Arial,sans-serif;">Vous pouvez vous connecter à Financia Capital avec votre compte ${identityProviderAlias!''} sans saisir votre mot de passe manuellement.</p>
          </td>
        </tr>
      </table>
