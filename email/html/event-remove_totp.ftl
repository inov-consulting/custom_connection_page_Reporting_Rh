...
<@layout.htmlEmailLayout accentColor="#D97706" category="SÉCURITÉ DU COMPTE">
  ...
  <tr>
    <td style="padding:32px 32px 28px;font-family:Arial,Helvetica,sans-serif;">
      ...
      <p style="margin:0 0 24px;font-size:14px;color:#555555;line-height:1.6;">L'authentification à deux facteurs a été désactivée sur votre compte Financia Capital. Votre compte est désormais protégé uniquement par votre mot de passe.</p>
